...
const EN_MESSAGES = {
  ...
  "settings.tabs.modelsDescription": "Providers and model assignment",
  "settings.models.title": "Model Providers",
  "settings.models.description":
    "Configure providers (OpenAI-compatible or Anthropic) and assign a model to each feature.",
  "settings.models.addProvider": "Add Provider",
  "settings.models.empty": "No providers yet. Add one to get started.",
  "settings.models.format.openai": "OpenAI-compatible",
  "settings.models.format.anthropic": "Anthropic",
  "settings.models.enable": "Enable provider",
  "settings.models.edit": "Edit",
  "settings.models.duplicate": "Duplicate",
  ...
  "settings.models.batchDelete": "Delete Selected",
  "settings.models.test": "Test",
  "settings.models.testing": "Testing...",
  "settings.models.noModels": "No models yet. Fetch from the provider or add one manually.",
  "settings.models.fetchSuccess": "Model list updated",
  "settings.models.fetchFailed": "Failed to fetch models",
  "settings.models.testOk": "Connection OK",
  "settings.models.testFailed": "Test failed",
  "settings.models.editor.newTitle": "Add Provider",
  "settings.models.editor.editTitle": "Edit Provider",
  "settings.models.editor.name": "Name",
  "settings.models.editor.id": "ID",
  "settings.models.editor.idHelp": "Stable identifier used to reference this provider.",
  "settings.models.editor.format": "Format",
  "settings.models.editor.baseUrl": "Base URL",
  "settings.models.editor.apiKey": "API Key",
  "settings.models.editor.apiKeyHelp": "Stored in plain text in your local settings file.",
  "settings.models.editor.nameRequired": "Name and ID are required.",
  "settings.models.editor.duplicateId": "A provider with this ID already exists.",
  "settings.models.modelEditor.newTitle": "Add Model",
  "settings.models.modelEditor.editTitle": "Edit Model",
  "settings.models.modelEditor.id": "Model ID",
  "settings.models.modelEditor.name": "Display Name",
  "settings.models.modelEditor.idRequired": "Model ID is required.",
  "settings.models.assignTitle": "Feature Models",
  "settings.models.assignDescription": "Choose which model each feature uses.",
  "settings.models.feature.ingest": "Ingest",
  "settings.models.feature.query": "Query",
  "settings.models.feature.translate": "Translate",
  "settings.models.assignNone": "Not set",
...
const MESSAGES: Record<AppLanguage, Record<TranslationKey, string>> = {
  ...
  zh: {
    ...
    "settings.tabs.modelsDescription": "提供商与模型分配",
    "settings.models.title": "模型提供商",
    "settings.models.description": "配置提供商（OpenAI 兼容或 Anthropic 格式），并为每个功能分配模型。",
    "settings.models.addProvider": "添加提供商",
    "settings.models.empty": "还没有提供商，先添加一个。",
    "settings.models.format.openai": "OpenAI 兼容",
    "settings.models.format.anthropic": "Anthropic",
    "settings.models.enable": "启用提供商",
    "settings.models.edit": "编辑",
    "settings.models.duplicate": "复制",
    ...
    "settings.models.batchDelete": "批量删除",
    "settings.models.test": "模型测试",
    "settings.models.testing": "测试中...",
    "settings.models.noModels": "暂无模型，可从提供商获取或手动添加。",
    "settings.models.fetchSuccess": "模型列表已更新",
    "settings.models.fetchFailed": "获取模型失败",
    "settings.models.testOk": "连接正常",
    "settings.models.testFailed": "测试失败",
    "settings.models.editor.newTitle": "添加提供商",
    "settings.models.editor.editTitle": "编辑提供商",
    "settings.models.editor.name": "名称",
    "settings.models.editor.id": "ID",
    "settings.models.editor.idHelp": "用于引用该提供商的稳定标识。",
    "settings.models.editor.format": "格式",
    "settings.models.editor.baseUrl": "Base URL",
    "settings.models.editor.apiKey": "API 密钥",
    "settings.models.editor.apiKeyHelp": "以明文形式保存在本地设置文件中。",
    "settings.models.editor.nameRequired": "名称和 ID 为必填项。",
    "settings.models.editor.duplicateId": "已存在相同 ID 的提供商。",
    "settings.models.modelEditor.newTitle": "添加模型",
    "settings.models.modelEditor.editTitle": "编辑模型",
    "settings.models.modelEditor.id": "模型 ID",
    "settings.models.modelEditor.name": "显示名称",
    "settings.models.modelEditor.idRequired": "模型 ID 为必填项。",
    "settings.models.assignTitle": "功能模型分配",
    "settings.models.assignDescription": "为每个功能选择要使用的模型。",
    "settings.models.feature.ingest": "导入",
    "settings.models.feature.query": "问答",
    "settings.models.feature.translate": "翻译",
    "settings.models.assignNone": "未设置",
    "common.cancel": "取消",
    "common.save": "保存",
  },
};
